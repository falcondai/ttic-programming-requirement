...
def build_model(observation_shape, n_actions, batch=None, n_cnn_layers=4, n_rnn_dim=256):
    ...
    # attention
    cell = tf.contrib.rnn.AttentionCellWrapper(cell, attn_length=32)
    print cell.state_size, cell.output_size

    initial_state_ph = tf.placeholder('float', [batch, cell.state_size], name='initial_state')
    ...
    zero_state = np.zeros((1, cell.state_size))
